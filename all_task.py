...
a студент может выставлять только одну итоговую оценку за курс определенному ментору. Больше одной оценки
программа выставить не даст (строка 52-53). Поэтому создал функцию по средней оценке лектора за проведенные им курсы
'''
